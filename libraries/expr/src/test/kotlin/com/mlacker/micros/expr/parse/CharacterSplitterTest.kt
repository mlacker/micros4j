...
internal class CharacterSplitterTest {
    ...
    @Test
    fun `closing brackets with negative`() {
        assertSplit("Add((1+2),3)-4", "Add(", "(", "1", "+", "2", ")", ",", "3", ")", "-", "4")
    }

    @Test
    fun `function with negative`() {
        assertSplit("Add(-1,-1)", "Add(", "-1", ",", "-1", ")")
    }
