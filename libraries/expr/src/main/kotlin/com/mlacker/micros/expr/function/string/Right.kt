...
class Right(parameters: List<Expression>) : Function(parameters) {
    init {
    ...
    override fun eval(variables: Map<String, Any>): Any? {
        ...
        return text.substring(text.length - length.toInt())
    }

    override fun generate(variables: Map<String, Any>): String {
        return "right(${parameters[0].generate(variables)}, ${parameters[1].generate(variables)})"
    }
}
